...
>
> **What it still needs.** Twenty bot games at the full length: median score 9, mean 27.5, top 183. That gap is the finding. Closures are still rare — the weather works and the economy doesn't — but *rattling* isn't: a temple pays 2 every time a gust shoves it, there are half a dozen temples on a full board, and thirty-odd gusts a game. Paying only once per temple per turn took the worst case down from 625 to 183, and the rattle economy still dwarfs the closure economy in the games where the wind gets going. The knobs, in order: drop the rattle to 1, or pay only the temple a gust reaches first, or leave it and make finishing worth more — more Abbazias, a looser temple trigger than all eight neighbours, or a payout for crystallised tiles at the end.
