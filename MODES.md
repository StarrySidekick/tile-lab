...
>
> **What it still needs.** Twenty bot games: 244 gusts, 47 tiles lost to the sky, and **ten closures** — half a scoring feature per game, mean score 10. The weather works; the economy doesn't. The Abbazia is the lever (four in fifty-six), and the temple still almost never completes: one exhale in twenty games. If the next pass does one thing, it should be making finishing possible again — more Abbazias, a looser temple trigger, or paying something for crystallised tiles at the end.
